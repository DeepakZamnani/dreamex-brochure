...
export type ThemeType = 'Luxury' | 'Minimal' | 'Editorial';
...
// ============================================================================
// DESIGN CONFIG (Generated by Gemini AI)
// ============================================================================
...
export interface DesignConfig {
  ...
  pageLayouts: {
    cover: 'classic-full' | 'modern-split' | 'minimalist-center';
    ethos: 'magazine-text' | 'visual-heavy' | 'clean-grid';
    amenities: 'dark-gallery' | 'light-list' | 'iconic-grid';
    location: 'map-focus' | 'text-focus' | 'split-view';
    specs: 'tabular' | 'artistic-blocks' | 'minimal-labels';
  };
  copy: {
    aiTagline: string;
    aiNarrative: string;
